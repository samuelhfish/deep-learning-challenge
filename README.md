...
### SUMMARY
The best model from  kerastuner method was able to achieve a 73% accuracy rate and 55% loss which is the best we have seen yet. The top models all used the hyberbolic tangent functions and 3-4 hidden layers.
